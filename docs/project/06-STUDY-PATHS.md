...
اكتملت Slice 1 من Study Paths V1 كنموذج مجال static ونقي في Git، واكتملت Slice 2 كطبقة قراءة عامة static. يدعم النموذج مسارًا بهوية دائمة وmetadata عرض وحالة و`currentVersion`، وإصدارات منهج ذات وحدات مرتبة وأهداف تعلم ودروس مطلوبة مرتبة تشير إلى `lesson_key` فقط. يوجد fixture تقني صغير بحالة `draft` للاختبار؛ ليس مسارًا علميًا منشورًا ولا يدخل الكتالوج العام.
...
بعد اكتمال نموذج المجال وصفحات القراءة العامة static، الخطوة التالية هي registry النشر الأدنى في Supabase، ثم التسجيل وواجهته وتقدم المسار الظاهر، وأخيرًا دمج «مساراتي» والتحقق التشغيلي. أدوات التحرير والتوصيات ليستا ضمن V1 الحالي.
