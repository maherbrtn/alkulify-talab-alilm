...
- [ ] index للمسارات وصفحة current وصفحة version تاريخية من تعريف Git فقط.
- [ ] حل `lesson_key` إلى route الدرس الحالية وقت البناء.
- [ ] ضمان بقاء القراءة عامة وعدم اعتماد render على Supabase registry.
